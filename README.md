...
Module used to set up your internal load balancer, and optionally Cloudfront and a WAF.
...
| <a name="input_zone_id"></a> [zone\_id](#input\_zone\_id) | The zone id of the domain for the account. | `string` | n/a | yes |
